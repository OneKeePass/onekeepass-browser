(ns onekeepass.browser.content.inject.db-icons
  (:require [onekeepass.browser.common.mui-components
             :as m
             :refer [mui-box mui-svg-icon mui-icon-vpn-key-outlined]]))

(def ^:private all-icons {0
